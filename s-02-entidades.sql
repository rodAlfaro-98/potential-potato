...
create table EMPLEADO(
  ...
  sueldo_quincenal generated always as (round(sueldo_mensual/2,2)) virtual,
  sueldo_anual generated always as (sueldo_mensual*12) virtual
);
...
create table REVISION_MASCOTA_ADOPTADA(
  ...
  numero_revision number(10,0) default 1 not null,
